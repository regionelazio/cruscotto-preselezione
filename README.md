...
- Pannelli comprimibili tramite freccia o titolo; il pannello Filtri parte chiuso per lasciare più spazio ai contenuti ed è espandibile quando necessario.
...
La dashboard supporta una modalità compatta attivata dal parametro `embed=1`:

```html
<iframe
  src="https://tuodominio.it/percorso/index.html?embed=1"
  width="100%"
  height="1200"
...
La modalità embedded utilizza tutta la larghezza disponibile, riduce spazi, mappa e grafici e mostra il comando “Apri a schermo intero”. Il comando rimuove soltanto `embed=1` dall'URL e conserva eventuali altri parametri.
...
- Aggiunta la modalità compatta `?embed=1` per l'incorporamento tramite iframe SharePoint.
- Aggiunto il pulsante “Apri a schermo intero”, visibile esclusivamente nella modalità embedded.
- Introdotte regole responsive dedicate agli iframe ampi, medi e mobili.
- Ridotte altezze e spaziature di pannelli, mappa, grafici e tabella nella modalità embedded.
- Aggiornati footer e documentazione alla versione 1.2.
